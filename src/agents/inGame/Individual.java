...
public class Individual {
    ...
    public void calculateFitness(){
        ...
        scoreMap.put(Config.ScoreType.Win, (float) (model.getGameStatus() == GameStatus.WIN ? Config.SCORE[Config.ScoreType.Win.ordinal()] : 0));
    ...
    public boolean[] getActions(int index){
        return intToBooleanArray(chromosome[index], Config.ACTIONS.length);
    }
